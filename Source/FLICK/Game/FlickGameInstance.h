...
public:
	...
	float GetGameplayCameraDistance() const { return GameplayCameraDistance; }
	...
	void SetGameplayCameraDistance(float Distance);
	void SetGameplayCameraFieldOfView(float FieldOfView);
...
private:
	...
	float GameplayCameraDistance = 0.9f;

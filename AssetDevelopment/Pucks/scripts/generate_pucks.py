...
def material(name, color, metallic, roughness, emission=0):
    ...
    return m
silver=material('01_Satin_Titanium',(0.58,0.64,0.72),0.96,0.19)
dark=material('02_Graphite_Chassis',(0.018,0.030,0.045),0.78,0.25)
rubber=material('03_Grip_Polymer',(0.012,0.018,0.025),0.05,0.54)
inset=material('04_Ceramic_Insert',(0.012,0.023,0.036),0.48,0.18)
cyan=material('05_Team_Cyan',(0.0,0.30,0.65),0.0,0.3,1.8)
orange=material('05_Team_Orange',(0.8,0.10,0.0),0.0,0.3,1.8)
black=material('06_Recess',(0.003,0.006,0.010),0.25,0.38)

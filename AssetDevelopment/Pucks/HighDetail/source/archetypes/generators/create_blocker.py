"""Blocker puck — 106.1 cm diameter, 16.5 cm visible height.
Based on the approved first Standard puck script: original materials retained.
Open in Blender's Text Editor and Run Script. Saves Blocker.blend with the supplied script's writable output folder selection.
Standalone; no other scripts, textures, or libraries required inside Blender.
Regular Python writes Blocker.glb. Geometry is modeled in meters with Z up.
"""
ASSET = 'Blocker'
DIAMETER_CM = 106.1
VISIBLE_HEIGHT_CM = 16.5
PHYSICS_HEIGHT_CM = 18.4

"""Grippy puck — 90.3 cm diameter, 20.9 cm visible height.
Based on the approved first Standard puck script: original materials retained.
Open in Blender's Text Editor and Run Script. Saves Grippy.blend with the supplied script's writable output folder selection.
Standalone; no other scripts, textures, or libraries required inside Blender.
Regular Python writes Grippy.glb. Geometry is modeled in meters with Z up.
"""
ASSET = 'Grippy'
DIAMETER_CM = 90.3
VISIBLE_HEIGHT_CM = 20.9

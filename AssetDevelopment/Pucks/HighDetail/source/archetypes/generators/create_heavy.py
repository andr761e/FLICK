"""Heavy puck — 97.5 cm diameter, 27.3 cm visible height.
Based on the approved first Standard puck script: original materials retained.
Open in Blender's Text Editor and Run Script. Saves Heavy.blend with the supplied script's writable output folder selection.
Standalone; no other scripts, textures, or libraries required inside Blender.
Regular Python writes Heavy.glb. Geometry is modeled in meters with Z up.
"""
ASSET = 'Heavy'
DIAMETER_CM = 97.5
VISIBLE_HEIGHT_CM = 27.3
PHYSICS_HEIGHT_CM = 23.6

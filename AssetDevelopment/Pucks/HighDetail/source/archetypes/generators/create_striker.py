"""Striker puck — 82.7 cm diameter, 13.4 cm visible height.
Based on the approved first Standard puck script: original materials retained.
Open in Blender's Text Editor and Run Script. Saves Striker.blend with the supplied script's writable output folder selection.
Standalone; no other scripts, textures, or libraries required inside Blender.
Regular Python writes Striker.glb. Geometry is modeled in meters with Z up.
"""
ASSET = 'Striker'
DIAMETER_CM = 82.7
VISIBLE_HEIGHT_CM = 13.4
PHYSICS_HEIGHT_CM = 16.4

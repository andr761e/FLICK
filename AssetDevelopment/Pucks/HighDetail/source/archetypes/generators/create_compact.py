"""Compact puck — 71.9 cm diameter, 14.7 cm visible height.
Based on the approved first Standard puck script: original materials retained.
Open in Blender's Text Editor and Run Script. Saves Compact.blend with the supplied script's writable output folder selection.
Standalone; no other scripts, textures, or libraries required inside Blender.
Regular Python writes Compact.glb. Geometry is modeled in meters with Z up.
"""
ASSET = 'Compact'
DIAMETER_CM = 71.9
VISIBLE_HEIGHT_CM = 14.7

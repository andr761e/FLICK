"""Toppler puck — 90.3 cm diameter, 30.7 cm visible height.
Based on the approved first Standard puck script: original materials retained.
Open in Blender's Text Editor and Run Script. Saves Toppler.blend with the supplied script's writable output folder selection.
Standalone; no other scripts, textures, or libraries required inside Blender.
Regular Python writes Toppler.glb. Geometry is modeled in meters with Z up.
"""
ASSET = 'Toppler'
DIAMETER_CM = 90.3
VISIBLE_HEIGHT_CM = 30.7
PHYSICS_HEIGHT_CM = 27

"""Bouncer puck — 86.5 cm diameter, 16.1 cm visible height.
Based on the approved first Standard puck script: original materials retained.
Open in Blender's Text Editor and Run Script. Saves Bouncer.blend with the supplied script's writable output folder selection.
Standalone; no other scripts, textures, or libraries required inside Blender.
Regular Python writes Bouncer.glb. Geometry is modeled in meters with Z up.
"""
ASSET = 'Bouncer'
DIAMETER_CM = 86.5
VISIBLE_HEIGHT_CM = 16.1
PHYSICS_HEIGHT_CM = 18
